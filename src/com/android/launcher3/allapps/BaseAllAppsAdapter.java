...
public abstract class BaseAllAppsAdapter
    ...
    public static final int VIEW_TYPE_FOLDER = 1 << 11;

    // Common view type masks
    public static final int VIEW_TYPE_MASK_DIVIDER = VIEW_TYPE_ALL_APPS_DIVIDER;
    public static final int VIEW_TYPE_MASK_ICON = VIEW_TYPE_FOLDER | VIEW_TYPE_ICON | VIEW_TYPE_PRIVATE_SPACE_APP_ICON;
