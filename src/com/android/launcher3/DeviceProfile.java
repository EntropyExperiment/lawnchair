...
public class DeviceProfile {
    ...
    DeviceProfile(InvariantDeviceProfile inv, Info info,
        ...
        // pE-TODO(QPR2): Where's Context???
        mTextFactors = DeviceProfileOverrides.INSTANCE.get(getContext(info, windowBounds.rotationHint, windowBounds)).getTextFactors();

        preferenceManager2 = PreferenceManager2.INSTANCE.get(getContext(info, windowBounds.rotationHint, windowBounds));
        ...
        // pE-TODO(QPR2): Reimpl workspacePageIndicatorHeight
        ...
        // pE-TODO(QPR2): Reimpl hotseatMode
        ...
        // pE-TODO(Qpr2): Reimpl notification dots
    ...
    public void updateIconSize(float scale, Context context) {
        ...
        // pE-TODO(QPR2): Reimpl iconTextSizePx
//        iconTextSizePx *= mTextFactors.getIconTextSizeFactor();
    ...
    private FolderProfile updateFolderCellSize(float scale, Resources res, Context context) {
        ...
        // pE-TODO(QPR2): Reimpl folderLabelTextSizePx, folderChildTextSizePx
