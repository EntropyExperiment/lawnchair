...
object PredictionAppKey {
    ...
    fun create(componentName: ComponentName, userToken: String): String =
        "${componentName.packageName}$DELIMITER${componentName.className}$DELIMITER$userToken"
