...
class AppUsageStore(
    ...
    private fun load(): MutableList<String> = (prefs.getString(storeName, "") ?: "")
        .split(DELIMITER)
        .filter { it.isNotEmpty() }
        .toMutableList()

    private fun save() {
        prefs.edit { putString(storeName, list.joinToString(DELIMITER)) }
    }
    ...
    companion object {
        ...
        /** Creates or returns the shared [SharedPreferences] backing both stores. */
